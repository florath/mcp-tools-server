...
from src.mcp_tools_server.tools.remove_file import RemoveFileTool
...
@pytest.fixture
def remove_file(security_validator):
...
@pytest.mark.asyncio
async def test_remove_file_basic_removal(file_remover, test_file):
    ...
    result = await remove_file.execute(params)
...
@pytest.mark.asyncio
async def test_remove_file_with_backup(file_remover, test_file):
...
@pytest.mark.asyncio
async def test_remove_file_with_force(file_remover, test_file):
...
@pytest.mark.asyncio
async def test_remove_file_nonexistent_file(remove_file):
    ...
    with pytest.raises(ValueError, match="File does not exist"):
        await remove_file.execute(params)


@pytest.mark.asyncio
async def test_remove_file_missing_reason(file_remover, test_file):
...
@pytest.mark.asyncio
async def test_remove_file_directory_not_file(file_remover, security_validator):
...
def test_remove_file_tool_info():
